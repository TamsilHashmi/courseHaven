...
function AdminSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("AdminSignup successfull: ", response.data);
  ...
  return (
    <div className="relative min-h-screen bg-[#0f172a] overflow-hidden flex flex-col items-center justify-center text-white font-sans py-12">
      {/* Dynamic Background Elements - Admin Theme (Blue/Purple) */}
      ...
      <div className="absolute top-[20%] right-[10%] w-[20%] h-[20%] bg-indigo-600/20 rounded-full blur-[100px] mix-blend-screen pointer-events-none"></div>

      {/* Header */}
      <header className="absolute top-0 left-0 w-full flex justify-between items-center p-6 z-20">
        <div className="flex items-center space-x-3">
          <Link to={"/"} className="flex items-center space-x-3">
            <img src={logo} alt="Logo" className="w-10 h-10 rounded-full shadow-lg shadow-blue-500/20" />
            <span className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 tracking-tight hidden sm:block">
              CourseHaven
            </span>
          </Link>
        </div>
      ...
      <div className="relative z-10 w-full max-w-md px-6 mt-16">
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 p-8 sm:p-10 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
          <div className="text-center mb-8">
            <div className="inline-block bg-blue-500/20 border border-blue-500/30 text-blue-400 text-xs font-bold px-3 py-1 rounded-full mb-4 uppercase tracking-wider">
              Admin Portal
            </div>
            ...
            <p className="text-sm text-gray-400">
              Restricted Access • Secure Registration
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-3.5 rounded-xl bg-white/5 border border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all text-white placeholder-gray-500 pr-12"
                  placeholder="••••••••"
                  required
                />
            ...
            <button
              type="submit"
              className="w-full mt-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold py-3.5 px-6 rounded-xl shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] transform hover:-translate-y-0.5 transition-all duration-200"
            >
              Secure Sign Up
            </button>
          </form>
